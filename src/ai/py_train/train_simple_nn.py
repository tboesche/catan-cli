...
source_dir = 'data/ai/random_ne_processed/short_data.hdf5'
...
train_loader = DataLoader(train_dataset, batch_size=4096, shuffle=True, num_workers=16)
val_loader = DataLoader(val_dataset, batch_size=4096, shuffle=False, num_workers=16)
...
for epoch in range(num_epochs):
    ...
    # print(f'Epoch [{epoch+1}/{num_epochs}], Train Loss: {avg_train_loss:.4f}, Val Loss: {avg_val_loss:.4f}, LR: {lr:.4f}')
...
# Save the model
stt.save_file(model.state_dict(), 'src/ai/simple_nn/weights_short.safetensors')
print("Model saved as weights.safetensors")
