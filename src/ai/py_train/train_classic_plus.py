...
file_path = "catan-cli/data/ai/classic_plus/weights.csv"

df_main = pl.read_csv("catan-cli/data/summaries/test_classic_only/main_results.csv")
df_details = pl.read_csv("catan-cli/data/summaries/test_classic_only/details.csv")
...
for i in range(5):
    formula = f'score ~ change_dr_{i} * (log_id + current_score + drawn_resource_0 + drawn_resource_1+ drawn_resource_2+ drawn_resource_3+ drawn_resource_4 + budget_resource_0 + budget_resource_1 + budget_resource_2 + budget_resource_3 + budget_resource_4)'
